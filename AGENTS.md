...
This project is indexed by GitNexus as **IPCCH** (3429 symbols, 5246 relationships, 151 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
