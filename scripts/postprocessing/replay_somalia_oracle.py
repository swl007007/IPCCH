...
def write_summary(report: Path, out: Path, metrics, contrasts, cohort, checks):
    ...
    lines = [
        ...
        "",
        "**Group-meeting focus:** isotonic-calibrated arm D at H=0/H=3 and discrimination (AUC), not F2 — see `calibration_diagnostics.md` (generated by `scripts/postprocessing/somalia_oracle_calibration_diagnostics.py`).",
        "",
    ...
    lines += [
        ...
        "- Climate-variable lineage (V2 calibration periods and realized-weather source identity) was waived by the user on 2026-09-24; both remain unverified.",
